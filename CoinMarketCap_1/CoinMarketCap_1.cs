    ...
    public class Script
    {
		...
		private void RunSafe(IEngine engine)
        {
            ...
            var httpCoinMarketCapElements = dms.GetElements().
                ...
                Contains("Exercise HTTP CoinMarketCap"));
            ...
            foreach (var element in httpCoinMarketCapElements)
            {
                ...
                var vrijednosti = table.GetData(2).Values;
                foreach (var vri in vrijednosti)
                {
                    engine.GenerateInformation($"Dobri dan: {vri.GetValue(2)}");
                }
            }
        }
        ...
        {
            string folderName = engine.GetScriptParam(10).Value;
